...
const Footer = () => {
  ...
  return (
    <footer className="relative overflow-hidden">
      {/* Gradient Background - Capital Navy */}
      ...
      <div className="relative z-10 border-t border-white/10">
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="glass-dark rounded-3xl p-8 md:p-12 text-center mb-16">
            <h3 className="text-3xl md:text-4xl font-bold mb-4 text-text-light">
              Ready to <span className="text-gradient-gold">Invest</span> with Us?
            </h3>
            <p className="text-text-light/70 mb-8 max-w-2xl mx-auto">
              Join our growing community of investors and benefit from strategic global investments.
            </p>
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 px-8 py-4 gradient-success text-text-light font-bold rounded-full shadow-emerald hover:scale-105 transition-transform"
            >
              Get Started Today
            </Link>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="lg:col-span-2">
              <Link to="/" className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <span className="text-2xl font-bold block text-text-light">
                    AIO <span className="text-secondary-light">Capital</span>
                  </span>
                  <span className="text-xs text-text-light/60">Growth Capital Fund SPC</span>
                </div>
              </Link>
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-center gap-3 text-text-light/70">
            ...
            {/* Quick Links */}
            <div>
              <h4 className="font-bold text-lg mb-6 flex items-center gap-2 text-text-light">
              ...
              <ul className="space-y-4">
                {navLinks.slice(0, 3).map((link) => (
                  <li key={link.name}>
                    <Link
                      to={link.href}
                      className="text-text-light/70 hover:text-secondary-light transition-colors flex items-center gap-2 group"
                    >
                      <span className="w-0 h-0.5 bg-secondary-light group-hover:w-3 transition-all duration-300"></span>
                      {link.name}
                    </Link>
                  </li>
                ))}
        ...
        <div className="border-t border-white/5 bg-white/[0.02]">
          <div className="max-w-7xl mx-auto px-6 py-4">
            <p className="text-text-light/50 text-xs text-center leading-relaxed">
