      ...
      <section className="py-24 bg-bg-secondary">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {highlights.map((item, index) => (
              <Link
                key={index}
                to={item.link}
                className="group bg-bg-card border border-border rounded-2xl p-8 hover:border-secondary/50 hover:bg-bg-card-hover transition-all duration-300"
              >
                <div className="w-16 h-16 gradient-gold rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
          ...
          <div className="mt-16 text-center">
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 px-8 py-4 gradient-gold text-primary-dark font-bold rounded-full shadow-gold hover:scale-105 transition-transform text-lg"
            >
              Get In Touch
              <ArrowRight size={20} />
            </Link>
